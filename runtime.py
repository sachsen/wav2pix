...
parser.add_argument(
    ...
    default=20,
    type=float,
    help="Regularization parameter for the softmax loss",
)
parser.add_argument("--image_size", default=128, type=int)
parser.add_argument(
    "--lr_D", default=0.0004, type=float, help="learning rate of the disciminator"
)
parser.add_argument(
    "--lr_G", default=0.0001, type=float, help="learning rate of the generator"
)
parser.add_argument(
    "--audio_seconds",
    default=1,
    type=float,
    help="desired audio duration to fed the network with",
)
